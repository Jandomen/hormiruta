                ...
                <div className="flex flex-col items-start sm:items-end gap-1">
                    {lastSync && (
                        <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20">
                            ...
                            <span className="text-[10px] font-black text-emerald-300 uppercase tracking-tighter">Sync: {lastSync}</span>
                        </div>
                    )}
                </div>
            </div>
                ...
                <div className="space-y-4">
                    <button
                        ...
                        className={cn(
                            ...
                            status === 'saved' ? "bg-emerald-600 text-white shadow-emerald-600/20" : "bg-red-600 hover:bg-red-700 text-white shadow-red-600/20",
                        ...
                        {message && (
                            <motion.div
                                ...
                                className={cn(
                                    ...
                                    status === 'error' ? "bg-red-500/10 text-red-400 border-red-500/20" : "bg-emerald-500/10 text-emerald-300 border-emerald-500/20"
                                )}
                            >
