            ...
            <div className="flex-1 overflow-y-auto p-6 xl:p-8 pt-8 xl:pt-10 space-y-8 xl:space-y-10 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-thumb]:bg-white/10 [&::-webkit-scrollbar-thumb]:rounded-full hover:[&::-webkit-scrollbar-thumb]:bg-white/20">
                <div className="space-y-5 xl:space-y-6">
                    <div className="bg-white/5 p-3 xl:p-4 rounded-2xl xl:rounded-[28px] border border-white/5 space-y-2 xl:space-y-3">
                        <p className="text-[8px] xl:text-[9px] font-black text-white/30 uppercase tracking-[0.2em] pl-1">Configuración de Trayecto</p>
                        ...
                        <div className="space-y-2 xl:space-y-3">
                            ...
                            <p className="text-[8px] xl:text-[9px] text-white/20 leading-relaxed">
                                {returnToStart
                        ...
                        <div className="pt-1 xl:pt-2 space-y-1.5 xl:space-y-2 border-t border-white/5 mt-1 xl:mt-2 pt-3 xl:pt-4">
                            <button
                                ...
                                className="w-full py-2.5 xl:py-3 bg-white/5 hover:bg-white/10 text-white rounded-lg xl:rounded-xl border border-white/5 text-[8px] xl:text-[9px] font-black uppercase tracking-widest flex items-center justify-center gap-1.5 xl:gap-2 transition-all disabled:opacity-20 disabled:cursor-not-allowed group"
                            >
                        ...
                        <div className="pt-1 xl:pt-2 space-y-1.5 xl:space-y-2">
                            <label className="text-[8px] xl:text-[9px] font-black text-white/20 uppercase tracking-widest pl-1">Punto de Partida</label>
                            <div className="flex items-center gap-2 xl:gap-3 p-2 xl:p-3 bg-dark/40 rounded-xl xl:rounded-2xl border border-white/5">
                                <MapPin className="w-3.5 h-3.5 xl:w-4 xl:h-4 text-info/40 shrink-0" />
                                <span className="text-[9px] xl:text-[10px] text-white/60 font-bold truncate">{originPoint.address}</span>
                            </div>
                            <button
                                onClick={() => refreshOriginLocation(true)}
                                className="w-full py-2.5 xl:py-3 bg-info/10 hover:bg-info/20 text-info rounded-lg xl:rounded-xl border border-info/20 text-[8px] xl:text-[9px] font-black uppercase tracking-widest flex items-center justify-center gap-1.5 xl:gap-2 transition-all group"
                            >
                    ...
                    <div className="space-y-2 xl:space-y-3">
                        <p className="text-[8px] xl:text-[9px] font-black text-white/30 uppercase tracking-[0.2em] pl-1">Selecciona tu Vehículo</p>
                        <div className="flex gap-3 xl:gap-4 overflow-x-auto pb-4 xl:pb-6 no-scrollbar -mx-2 px-2 snap-x scroll-smooth">
                            {vehicleOptions.map((opt) => (
                                ...
                                >
                                    ...
                                    <span className="text-[8px] xl:text-[9px] font-black uppercase tracking-tight text-center">{opt.label}</span>
                                </button>
                            ))}
                        </div>
                    </div>
                ...
                {!isPro && (
                    <div className="p-5 xl:p-6 bg-gradient-to-br from-info/10 to-blue-600/5 rounded-2xl xl:rounded-[32px] border border-info/20 relative overflow-hidden group">
                        ...
                        <p className="text-[9px] xl:text-[10px] text-white/40 leading-relaxed mb-3 xl:mb-4 font-medium">
                            Optimiza paradas ilimitadas y vuela con el modo OVNI.
                        </p>
                        <button
                            onClick={() => router.push('/pricing')}
                            className="block w-full py-2.5 xl:py-3 bg-info text-dark text-center text-[9px] xl:text-[10px] font-black uppercase tracking-widest rounded-lg xl:rounded-xl shadow-lg shadow-info/10 hover:scale-[1.02] active:scale-[0.98] transition-all"
                        >
                            Ser Premium
                        </button>
                    </div>
