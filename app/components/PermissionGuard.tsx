                                ...
                                {items.map((item) => (
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            item.state === 'granted' ? 'bg-blue-500/10 border-blue-500/20' : 'bg-white/5 border-white/5'
                                        )}
                                    >
                                        <div className="flex items-center gap-4">
                                            <div className={cn("w-10 h-10 rounded-xl flex items-center justify-center",
                                                item.state === 'granted' ? 'bg-blue-500/20' : 'bg-black/40'
                                            )}>
                                                <item.icon className={cn("w-5 h-5", item.state === 'granted' ? 'text-blue-300' : 'text-info/40')} />
                                            </div>
                                            <div>
