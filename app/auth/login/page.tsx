        ...
        <div className="min-h-screen bg-background flex items-center justify-center p-6 relative overflow-hidden">
            ...
            >
                <div className="mb-8 text-center">
                    ...
                    <p className="text-blue-200/50 mt-2">Accede a tu panel de control de HORMIRUTA</p>
                </div>
                ...
                <div className="premium-card p-8 shadow-2xl backdrop-blur-xl border border-white/10">
                    <form onSubmit={handleLogin} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-4 bg-info hover:bg-info/90 text-dark font-black rounded-xl shadow-[0_0_20px_rgba(49,204,236,0.2)] transition-all flex items-center justify-center gap-2 group"
                        >
                            {loading ? (
