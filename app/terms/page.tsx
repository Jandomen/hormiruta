                ...
                <div className="flex items-center justify-between mb-4 sm:mb-16 gap-1 sm:gap-2">
                    ...
                    <div className="flex items-center gap-1.5 sm:gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-[6px] sm:text-[10px] text-info font-bold uppercase tracking-[0.3em]">HormiRuta v2.5</p>
                        </div>
                    </div>
                </div>
                ...
                >
                    <div className="space-y-2 sm:space-y-4">
                        <div className="inline-block px-1.5 sm:px-4 py-0.5 sm:py-1.5 bg-info/10 border border-info/20 rounded-full">
                            <span className="text-[7px] sm:text-[10px] font-black text-info uppercase tracking-widest">Última actualización: Febrero 2026</span>
                        </div>
                        ...
                        {sections.map((section, idx) => (
                            ...
                            >
                                <div className="shrink-0 w-6 h-6 sm:w-10 sm:h-10 lg:w-14 lg:h-14 bg-white/5 border border-white/10 rounded-lg sm:rounded-[22px] flex items-center justify-center group-hover:bg-info/10 group-hover:border-info/30 transition-all">
                                    <section.icon className="w-3 h-3 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-white/40 group-hover:text-info transition-colors" />
                                </div>
                                <div className="space-y-0.5 sm:space-y-3 min-w-0">
                                    ...
                                    <p className="text-white/50 text-[9px] sm:text-xs lg:text-sm leading-relaxed font-medium">
                                        {section.content}
                                    </p>
                                </div>
                            </motion.div>
                    ...
                    <div className="pt-4 sm:pt-12 border-t border-white/5 flex flex-col lg:flex-row items-center justify-between gap-3 sm:gap-8 text-center lg:text-left">
                        <div>
                            <p className="text-[7px] sm:text-[11px] font-bold text-white/30 uppercase tracking-widest mb-0.5 sm:mb-2">Para dudas legales:</p>
                        ...
                        >
                            <div className="flex items-center gap-1.5 sm:gap-3">
                                ...
                                <span className="text-[7px] sm:text-xs font-black uppercase tracking-widest group-hover:text-dark transition-colors">Aviso de Privacidad</span>
                                <ExternalLink className="w-2.5 h-2.5 sm:w-4 sm:h-4 text-white/20 group-hover:text-dark/40 transition-colors" />
                            </div>
                        </Link>
                    </div>
                </motion.div>
